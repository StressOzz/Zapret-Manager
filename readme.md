...
- Включить локальный **SOCKS5** прокси для **Telegram**
...
**Пункт 2** —  установка или удаление **TG WS Proxy Go**

Потдерживаются архитектуры **mipsel_24kc**, **mips_24kc**, **armv7**, **aarch64** и **x86_64**
