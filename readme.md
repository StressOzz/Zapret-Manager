...
│  ├─9 Добавить / Удалить Spotify
│  ├─10  Добавить / Удалить Supercell
│  ├─88 Добавить / Удалить все домены
│  ├─99 Восстановить hosts
│  └─Enter Выход в меню стратегий
│
├─ 8 Удалить → установить → настроить Zapret
│
├─ 9 Меню управления настройками
...
└─ 0 Системное меню
   ...
   ├─ 6 Удалить Zapret
   ├─ 7 Включить / Выключить IPv6 в Zapret
