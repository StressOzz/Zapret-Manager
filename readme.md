...
- Выбрать стратегию для установки **v1-v8**
...
- Откроет доступ к **AI** сервисам без **VPN**
...
│  ├─ 9 Тестирование всех стратегий
│  ├─ 0 Результат тестирования стратегий
...
└─ 0 Системное меню
   ...
   ├─ 4 Запустить проверку blockcheck
