...
> Что работает у других, не обязательно будет работать у Вас и наоборот.
...
Выбрать **Пункт 8**: `Удалить → установить → настроить Zapret`

Устанавливает **Zapret** под ключ — автоматически и без пауз выполняются пункты меню - **5** → **1** → **2** → **7** → **6** 
- Удаляет Zapret
