...
# 💡  **Рекомендую установить Zapret Manager WEB + LuCI**
>[!NOTE]
> Удобнее всего управлять всем из браузера.
> 
> Установите панель один раз — пункт **w** в главном меню — и откройте ссылку из строки `WEB + LuCI:` (например, `http://192.168.1.1:7788`) на компьютере или телефоне, также появится пункт Zapret Manager в LuCI
>
