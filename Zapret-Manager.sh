...
printf "%s\n" "--new" "--filter-udp=19294-19344,50000-50100" "--filter-l7=discord,stun" "--dpi-desync=fake" "--dpi-desync-fake-discord=/opt/zapret/files/fake/quic_initial_www_google_com.bin" "--dpi-desync-fake-stun=/opt/zapret/files/fake/quic_initial_www_google_com.bin" \
