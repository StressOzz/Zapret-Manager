...
# =========================================
ZAPRET_MANAGER_VERSION="9.2"; STR_VERSION_AUTOINSTALL="v7"
ZAPRET_VERSION="$(curl -Ls -o /dev/null -w '%{url_effective}' https://github.com/remittor/zapret-openwrt/releases/latest | sed -E 's#.*/tag/v?##')"
