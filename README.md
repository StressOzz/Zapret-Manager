...
- Если у Вас установлен **ByeDPI** или **youtubeUnblock** скрипт выдаст сообщение и предложит его удалить иначе скрипт завершит работу.
...
[Видеоинструкция, как запустить менеджер в браузерe через LuCI](https://www.youtube.com/watch?v=9YptN75Me_k)
