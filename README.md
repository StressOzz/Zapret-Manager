...
> Тут описан один из способов обхода блокировок, основанный на дефолтной стратеги.
...
<details>
  <summary>Показать текст</summary>
    ...
    ```
    Здесь ваш текст, который можно копировать.
    ```
    Можно вставлять несколько строк,
    и всё будет удобно для копирования.
...
Откроется меню с информацией какой скрипт сейчас активен и возможностью выбрать для установки один из двух скриптов
